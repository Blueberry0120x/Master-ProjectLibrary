...
- MapEngine dim state: `showBldgDims`, `hiddenDimKeys`, `mergedDimKeys`, `chainWOffset`, `chainDOffset`, `propDimOffsets`
...
```
{
  ...
  saved: {
    ...
    mergedDimKeys: [...],  // Set → Array (merged dim segments)
    chainWOffset, chainDOffset,
    propDimOffsets: {},     // per-dim drag offsets (property line dims)
    parcelPolygon,         // edited polygon or null
    mapOpacity,
    setbacksApplied,
    freeDrag, snapEdge,
