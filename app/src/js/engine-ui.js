...
const UIEngine = {
    init: function() {
        ...
        var exSFText = exSF > 0 ? exSF.toLocaleString() + ' SF' : '--';
        var exBldg = document.getElementById('ui-exbldg');
        if (exBldg) exBldg.innerText = exSFText;
        var exBldgProj = document.getElementById('info-exbldg-proj');
        if (exBldgProj) exBldgProj.innerText = exSFText;
        var exBldgLand = document.getElementById('info-exbldg-land');
        if (exBldgLand) exBldgLand.innerText = exSFText;
    ...
    openSiteEditor: function() {
        ...
        document.getElementById('sei-exdwelling').value = sd.existingDwellingSF != null ? sd.existingDwellingSF : '';
    ...
    saveSiteInfo: function() {
        ...
        var payload = {
            ...
            existingDwellingSF: parseFloat(document.getElementById('sei-exdwelling').value) || 0,
